...
export const metadata: Metadata = {
  ...
  description: "Tradução juramentada de certidão de nascimento brasileira (inteiro teor) para cidadania italiana e casamento. Aceitação garantida em toda a Itália.",
  alternates: {
    canonical: pagePath,
  },
  openGraph: {
