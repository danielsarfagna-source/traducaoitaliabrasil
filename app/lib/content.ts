export const faqItems = [
  ["O que é tradução juramentada?", "É uma tradução utilizada quando o documento precisa ser apresentado com valor formal perante uma autoridade ou órgão oficial."],
  ["Tradução juramentada e tradução simples são iguais?", "Não. A tradução simples serve para leitura e compreensão. A juramentada é usada quando há exigência formal."],
  ["Vocês traduzem só documentos para cidadania?", "Não. Traduzimos qualquer documento: CNH, diplomas, históricos e documentos escolares, certidões, permesso di soggiorno, procurações, documentos de empresa e documentos italianos para uso no Brasil. Cidadania é só um dos casos."],
  ["Atendem em toda a Itália?", "Sim. O atendimento é feito em português e pode orientar clientes em toda a Itália."],
  ...
  ["Apostila de Haia é tradução?", "Não. A apostila certifica a origem formal do documento. A tradução converte o conteúdo para outro idioma."],
] as const;
